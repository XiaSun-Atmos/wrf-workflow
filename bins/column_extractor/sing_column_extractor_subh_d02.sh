...
doy=$(date -d "${YYYY}-${MM}-${DD}" +%j)
    ...
    ln -s /upp_out/${YYYY}${MM}${DD}${HH}/WRFNAThh.mm.tm00_d02 /data/input/wfip1km.wrfnat.hh.mm.tm00_d02
    ln -s /upp_out/${YYYY}${MM}${DD}${HH}/WRFPRShh.mm.tm00_d02 /data/input/wfip1km.wrfprs.hh.mm.tm00_d02
    ln -s /upp_out/${YYYY}${MM}${DD}${HH}/WRFTWOhh.mm.tm00_d02 /data/input/wfip1km.wrftwo.hh.mm.tm00_d02


    python3 src/main.py -c ./conf -f /data/input/wfip1km.wrfnat.hh.mm.tm00_d02 /data/input/wfip1km.wrfprs.hh.mm.tm00_d02 /data/input/wfip1km.wrftwo.hh.mm.tm00_d02
    rm -rf /data/input/wfip1km.wrfnat.hh.mm.tm00_d02 /data/input/wfip1km.wrfprs.hh.mm.tm00_d02 /data/input/wfip1km.wrftwo.hh.mm.tm00_d02
    rm -rf /data/input/wfip1km.wrfnat.hh.mm.tm00_d02*.idx /data/input/wfip1km.wrfprs.hh.mm.tm00_d02*.idx /data/input/wfip1km.wrftwo.hh.mm.15.tm00_d02*.idx
