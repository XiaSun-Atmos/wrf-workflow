...
Containerized Python workflow that extracts vertical profiles of select variables from RAP/HRRR/GFS (RRFS coming soon) model output over sites of interest.
