...
@author: jduncan
###############################################################################
This Function Will Output Appropriate Limits Based on the Model and Observed Data

Modified on Jan 16 to Account for the Case Where MEASx_mu was not Properly 
Determined to Data Availability Issues
...
def atmo_ylim(ATMOin,RNDbse,TICKint):
    ATMOarr = [];
    ###########################################################################
    for r in ATMOin:
