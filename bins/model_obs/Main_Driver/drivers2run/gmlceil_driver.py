...
# -*- coding: utf-8 -*-
"""
Driver for GML Ceilometer Information
...
Smeas = TROPoetree # -> TROPoe/Ceilometer data
...
######################################
from gmlceil_main_driver import gmlceil_driver
...
###############################################################################
""" Initiate Ceilometer Data Analysis"""
gmlceil_driver(signal_prm.gmlceil_oi,Doi,ANLYper, overwrite=True)
###############################################################################
# Indicate that Analyses is Complete #
print('#####################################################################')
print(station_prm.EXPname+' Ceilometer Data Analysis Complete: ' + Tstrt + '-' + Tstop)
print('#####################################################################')
