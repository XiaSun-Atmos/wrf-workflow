...
def rwp_WTSmeas(MEASin,OUTinfo,frequency=915):
    DATE = OUTinfo[3];
    ...
    MEAShubhgt_low_value = MEAShgt_low[MEAShubidx_low]
    MEAShubhgt_hgh_value = MEAShgt_hgh[MEAShubidx_hgh]
    ...
    for ini in range(0,len(INIpos)):
        ...
        ws_ax.plot(MEAStime,MEASws,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs ('+str(MEAShubhgt_value)+' m)')
        ...
        ###################################################################
        wd_ax = wd_plt(MEAStime,MEASwd,wd_ax,'s-','black','Obs ('+str(MEAShubhgt_value)+' m)',marker_size=plt_param.PLTmsize,line_width=plt_param.PLTlwidth)
        ...
        pow_ax.plot(MEAStime,MEASpow,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs ('+str(MEAShubhgt_value)+' m)')
