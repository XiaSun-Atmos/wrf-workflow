...
def rwp_WTSplot(MEASin,MDLin,OUTinfo,frequency=915):
    DATE = OUTinfo[3];
    ...
    MEAShubidx_low = np.argmin(np.abs(MEAShgt_low-HUBhgt));
    MEAShubidx_hgh = np.argmin(np.abs(MEAShgt_hgh-HUBhgt));
    MEAShubhgt_low_value = int(MEAShgt_low[MEAShubidx_low])
    MEAShubhgt_hgh_value = int(MEAShgt_hgh[MEAShubidx_hgh])
    ...
    ###########################################################################
    """ QC winds """
    # set wind speeds/dirs with QC > 2 to NaN
    ...
    if (HUBmode == 'low'):
        MEASws = MEASws_low[MEAShubidx_low,:]
        MEASwd = MEASwd_low[MEAShubidx_low,:]
        MEAShubhgt_value = MEAShubhgt_low_value
    else:
        MEASws = MEASws_hgh[MEAShubidx_hgh,:]
        MEASwd = MEASwd_hgh[MEAShubidx_hgh,:]
        ...
        for ini in range(0,len(INIpos)):
            ...
            if INIpos[ini] in MDLini:
                ...
                if len(MDLtime) > FXlen: #indicating forecast hours exceed standard forecast length
                    ...
                    MEASws_ext_mu = atmo_meas2hr_mid(MEASws,None,MEAStime,MDLtime_ext);
                    MEASpow_ext_mu = atmo_meas2hr_mid(MEASpow,None,MEAStime,MDLtime_ext);
                    MEASwd_ext_mu = wd_meas2hr_mid(MEASwd,None,MEAStime,MDLtime_ext);
                    ...
                    ###############################################################
                    # Perform Model Averaging for Plotting and Statistical Analsyes
                    MEASws_mu = atmo_meas2hr_mid(MEASws,None,MEAStime,MDLtime);
                    MEASwd_mu = wd_meas2hr_mid(MEASwd,None,MEAStime,MDLtime);
                    MEASpow_mu = atmo_meas2hr_mid(MEASpow,None,MEAStime,MDLtime);
                ...
                ws_ax.plot(MEAStime,MEASws,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs')
                ws_ax.plot(MDLtime,MDLws,'o-',color='red',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label=MDLname+MDLstr+' ('+str(MDLhgt_ref_value)+' m)')
                ...
                #wd_ax = wd_plt(MEAStime,MEASwd,wd_ax,'s-','black','Obs ('+str(MEAShubhgt_value)+' m)')
                wd_ax = wd_plt(MEAStime,MEASwd,wd_ax,'s-','black','Obs',marker_size=plt_param.PLTmsize,line_width=plt_param.PLTlwidth)
                wd_ax = wd_plt(MDLtime,MDLwd,wd_ax,'o-','red',MDLname+MDLstr+' ('+str(MDLhgt_ref_value)+' m)',marker_size=plt_param.PLTmsize,line_width=plt_param.PLTlwidth)
                ###################################################################
                ...
                pow_ax.plot(MEAStime,MEASpow,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs')
                pow_ax.plot(MDLtime,MDLpow,'o-',color='red',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label=MDLname+MDLstr+' ('+str(MDLhgt_ref_value)+' m)')
                ...
                if 'MDLtime_ext' in locals():
                    ...
                    ws_ax.plot(MEAStime,MEASws,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs')
                    ws_ax.plot(MDLtime_ext,MDLws_ext,'o-',color='red',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label=MDLname+MDLstr+' ('+str(MDLhgt_ref_value)+' m)')
                    ...
                    wd_ax = wd_plt(MEAStime,MEASwd,wd_ax,'s-','black','Obs',marker_size=plt_param.PLTmsize,line_width=plt_param.PLTlwidth)
                    wd_ax = wd_plt(MDLtime_ext,MDLwd_ext,wd_ax,'o-','red',MDLname+MDLstr+' ('+str(MDLhgt_ref_value)+' m)',marker_size=plt_param.PLTmsize,line_width=plt_param.PLTlwidth)
                    ###############################################################
                    wd_ax.grid('both',color='k',linestyle='-',linewidth=0.1,alpha=0.5)
                    ###############################################################
                    #handles, labels = wd_ax.get_legend_handles_labels()
                    ...
                    #####################################
                    #Observations 
                    #pow_ax.plot(MDLtime_ext,MEASpow_ext_mu,'s',color='gray',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs (1Hr Avg)')
                    pow_ax.plot(MEAStime,MEASpow,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs')
                    pow_ax.plot(MDLtime_ext,MDLpow_ext,'o-',color='red',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label=MDLname+MDLstr+' ('+str(MDLhgt_ref_value)+' m)')
                ...
                #####################################
                #Observations 
                #pow_ax.plot(MDLtime,MEASpow_mu,'s',color='gray',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs (1Hr Avg)')
                pow_ax.plot(MEAStime,MEASpow,'s-',color='black',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs')
                pow_ax.plot(MDLtime,MDLtime*np.nan,'o-',color='red',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label=MDLname+MDLstr)
                pow_ax.add_collection(LineCollection(MEASpow_up_segs,colors=(plt_param.POWramp_up_color),linewidths=(plt_param.PLTlwidth),label='Up ramps'))
                pow_ax.add_collection(LineCollection(MEASpow_down_segs,colors=(plt_param.POWramp_down_color),linewidths=(plt_param.PLTlwidth),label='Down ramps'))
                pow_ax.plot(MDLtime,MDLtime*np.nan,'-',color=plt_param.POWramp_up_color,markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label=' ')
                pow_ax.plot(MDLtime,MDLtime*np.nan,'-',color=plt_param.POWramp_down_color,markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='')
                pow_ax.grid('both',color='k',linestyle='-',linewidth=0.1,alpha=0.5)
                ###################################################################
                handles, labels = pow_ax.get_legend_handles_labels()
                order = [0,2,1,3]
