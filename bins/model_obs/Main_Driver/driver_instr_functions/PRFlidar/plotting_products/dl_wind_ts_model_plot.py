        ...
        for ini in range(0,len(INIpos)):
            ...
            if INIpos[ini] in MDLini:
                ...
                if len(MDLtime) > FXlen: #indicating forecast hours exceed standard forecast length
                    ...
                    ###############################################################
                    WSmin_ext,WSmax_ext,WStick_ext = atmo_bound_lim((\
                                                   MDLws),plt_param.WSrnd_bse,plt_param.WSmin,plt_param.WSmax,\
                                                   plt_param.WSrnd_bse)
                    #POWmin_ext,POWmax_ext,POWtick_ext = atmo_bound_lim((\
                    ...
                    MDLpow_up_segs, MDLpow_down_segs = ramp_up_down_segs(MDLtime,MDLpow,threshold=plt_param.POWthreshold)
                    ###############################################################
                    WSmin,WSmax,WStick = atmo_bound_lim((\
                                                   MDLws),plt_param.WSrnd_bse,plt_param.WSmin,plt_param.WSmax,\
                                                   plt_param.WSrnd_bse)
                ...
                ws_ax.plot(MDLtime,MDLtime*np.nan,'s-',color='gray',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs ('+AVGlabel+' Avg)')
                ws_ax.plot(MDLtime,MDLtime*np.nan,'.',color='black',markersize=1,linewidth=0,label='Obs')
                ...
                ###################################################################
                wd_ax = wd_plt(MDLtime,MDLtime*np.nan,wd_ax,'.','black','Obs',marker_size=1,line_width=0)
                ...
                ###################################################################
                #Define Bounds of Wind Speed - Model Bias to Determine Y-Bounds
                bias_ax.set_ylim(-90,90); bias_ax.set_yticks(np.arange(-90,90.1,45));
                bias_ax.tick_params(axis="y", labelsize=plt_param.TICKfs)
                ###################################################################
                bias_ax.set_ylabel('Model Error',{'fontsize': plt_param.LABELfs});    
                bias_ax.yaxis.set_label_coords(plt_param.Ylab_pad[0],plt_param.Ylab_pad[1]);
                ...
                #####################################
                #Observations -- Only Plotting the QC'd Values
                pow_ax.plot(MDLtime,MDLtime*np.nan,'.',color='black',markersize=1,linewidth=0,label='Obs')
                ...
                pow_ax.plot(MDLtime,MDLtime*np.nan,'-',color=plt_param.WSramp_up_color,markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Up ramps')
                pow_ax.plot(MDLtime,MDLtime*np.nan,'-',color=plt_param.WSramp_down_color,markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Down ramps')
                ...
                if 'MDLtime_ext' in locals():
                    ...
                    ####################################
                    #Observations -- Only Plotting the QC'd Values
                    ws_ax.plot(MDLtime_ext,MDLtime_ext*np.nan,'s-',color='gray',markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Obs ('+AVGlabel+' Avg)')
                    ws_ax.plot(MDLtime_ext,MDLtime_ext*np.nan,'.',color='black',markersize=1,linewidth=0,label='Obs')
                    ...
                    # Plot the Wind Direction Time Histories
                    ###############################################################
                    wd_ax = wd_plt(MDLtime_ext,MDLtime_ext*np.nan,wd_ax,'.','black','Obs',marker_size=1,line_width=0)
                    ...
                    #####################################
                    #Observations 
                    pow_ax.plot(MDLtime_ext,MDLtime_ext*np.nan,'.',color='black',markersize=1,linewidth=0,label='Obs')
                    ...
                    pow_ax.plot(MDLtime_ext,MDLtime_ext*np.nan,'-',color=plt_param.WSramp_up_color,markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Up ramps')
                    pow_ax.plot(MDLtime_ext,MDLtime_ext*np.nan,'-',color=plt_param.WSramp_down_color,markersize=plt_param.PLTmsize,linewidth=plt_param.PLTlwidth,label='Down ramps')
